...
| [Анализ рынка компьютерных игр](https://github.com/Inna-Mazhorova/portfolio/tree/main/estate) | Выявление определяющих успешность игры закономерностей | *pandas, numpy,  matplotlib, seaborn, scipy.stats* |